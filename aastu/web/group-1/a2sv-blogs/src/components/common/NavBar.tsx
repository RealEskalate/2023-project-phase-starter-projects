        ...
        <header>
            <div className="container px-12 w-full py-3 fixed top-0 bg-white	">
             <nav className="flex items-center">
                <div>
                <Image src="/images/a2sv-logo.svg" width={197} height={50} alt='Hero image'/>
                </div>
                <ul className=" flex-1 text-center font-normal text-nav-black	text-lg	">
                ...
                <div className="content-end	row-span-1">
                   ...
                   <span><button className='border border-2	rounded-xl px-5 w-22 h-12 bg-a2sv-blue text-white text-a2sv-blue text-base font-bold'> Donate </button></span>
