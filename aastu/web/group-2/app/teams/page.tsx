  ...
  return (
    <div className="flex flex-wrap ml-10 xl:ml-28 mt-40">
      <div className="w-full xl:w-[550px] mr-14">
        <h1 className="font-primaryFont text-[40px] font-bold text-[#2B2A35]">
          The team we’re currently working with
        </h1>
        <p className="font-secondaryFont mt-10 text-xl leading-8">
          ...
          managers and quality assurance specialists who are passionate about developing exceptional
