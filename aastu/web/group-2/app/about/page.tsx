        ...
        <div className='flex justify-center px-8'>
            <div className='flex justify-center flex-wrap mt-20 md:mt-30 text-center lg:text-left'>
                <div className='w-full lg:w-[400px] md:mr-14'>
                    ...
                    <p className='font-secondaryFont mt-10 lg:mt-24 italic text-l text-gray-700 leading-8 text-l'>A2SV is a social enterprise that enables high-potential university students to create digital solutions to Africa’s most pressing problems.</p>
                </div>
                        ...
                        <div className='bg-slate-900 h-[200px] rounded-2xl w-full relative flex md:justify-between'>
                            ...
                            <div className='text-white min-w-[200px] flex justify-start md:justify-center items-center pr-4'>
                                <div className='text-left md:text-right pl-4 md:pl-0'>
                                    <h1 className='text-xl md:text-xl font-semibold font-primaryFont'>20% percent growth</h1>
                                    <p className='text-base md:text-md font-secondaryFont mt-4 text-gray-300'>180% students growth</p>
                                    <p className='text-base md:text-md font-secondaryFont text-gray-300'>20% faster learning track</p>
                                </div>
                            </div>
                        </div>
...
const Section5Cards = ({title, icon, content }: cardType)=>{
    return(
        <div className='shadow-lg rounded-lg px-10 mt-10 pb-6 flex flex-col items-center text-center'>
