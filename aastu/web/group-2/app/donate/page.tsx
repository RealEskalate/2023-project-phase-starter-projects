        ...
        <div className="h-full w-full top-0 fixed overflow-y-scroll bg-slate-900/70 z-20 flex justify-center items-center flex-wrap pb-4">
            <div>
                <div className="fixed top-0 z-30 right-0 mt-5 mr-5">
                    <button onClick={(e: any) => handleClose(e)} className="text-3xl text-blue-700 bg-slate-50 rounded-full flex border-[3px] border-blue-800 justify-center items-center p-2">
                        <AiOutlineClose />
                    </button>
                </div>
                        ...
                        <div className="h-full rounded-xl bg-slate-100 p-4">
                            ...
                            <div className="flex justify-center mt-4">
                                <div className="rounded-lg border border-slate-700 flex justify-between w-64 cursor-pointer">
                                    <label
                                        htmlFor="give-once"
                                        className={`w-1/2 flex items-center justify-center border px-4 py-2 ${toggleOption == 'give-once' && 'border-2 border-blue-700'
                                            } rounded-lg`}
                                    >
                                        <input
                                            type="radio"
                                    ...
                                    <label
                                        htmlFor="monthly"
                                        className={`flex items-center w-1/2 justify-center border px-4 py-2 ${toggleOption == 'monthly' && 'border-2 border-blue-700'
                                            } rounded-lg`}
                                    >
                                        <input
                                            type="radio"
                                    ...
                                    <div className="flex flex-wrap gap-3 mx-2 justify-center mt-4">
                                        {radioOptions.map((option) => (
                                            <div key={option.id}>
                                                ...
                                                <label
                                                    htmlFor={option.id}
                                                    className={`w-20 flex justify-center border px-4 py-2 rounded-lg ${selectedOption === option.id
