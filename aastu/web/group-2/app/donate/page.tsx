...
const Donate = () => {
  ...
  return (
    <div className="h-full w-full top-0 fixed bg-slate-900/70 z-20 flex justify-center items-center flex-wrap">
      <div className="absolute top-0 right-0 mt-5 mr-5">
        <Link href="/">
          <button className="text-3xl text-slate-900 bg-slate-50 rounded-full flex justify-center items-center p-2">
            <AiOutlineClose />
          </button>
        </Link>
      </div>
      <div className="flex gap-10 relative">
        <div className="w-[450px] h-90 rounded-xl bg-slate-100">
          ...
          <p className="font-secondaryFont p-4 text-sm">
            ...
            people with the opportunities they deserve so they can bring their skills back to their
            home countries to continue expanding opportunity there by growing Africa’s tech hub
            potential.{' '}
          </p>
          <p className="font-secondaryFont mt-3 p-4">Make your contribution today!</p>
        </div>
        <div className="w-[350px] h-90 rounded-xl bg-slate-100 p-4">
          ...
          <div className="flex justify-center mt-4">
            <div className="rounded-lg border border-slate-700 flex justify-between w-64 cursor-pointer">
              <label
                htmlFor="give-once"
                className={`w-1/2 flex items-center justify-center border px-4 py-2 ${toggleOption == 'give-once' && 'border-2 border-blue-700'} rounded-lg`}
              >
                <input
                  type="radio"
                  id="give-once"
              ...
              <label
                htmlFor="monthly"
                className={`flex items-center w-1/2 justify-center border px-4 py-2 ${toggleOption == 'monthly' && 'border-2 border-blue-700'} rounded-lg`}
              >
                <input
                  type="radio"
                  id="monthly"
          ...
          <div className="mx-2">
            ...
            <div className='mt-10 mx-4 flex justify-center'>
                <input type="text" className='py-2 px-4 text-blue-700 font-bold outline-1 outline-blue-800 text-xl bg-transparent border-2 border-gray-300 w-full rounded-md' value={selectedOption}/>
            </div>
            <div className='absolute bottom-6 w-[300px] flex justify-center'>
