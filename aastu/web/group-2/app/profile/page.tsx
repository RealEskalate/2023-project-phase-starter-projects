        ...
        <div className="space-y-4">
            <div className='flex flex-col items-center gap-4 md:flex-row md:justify-between py-2 border-b-2 border-[#EFEFEF] mb-7 px-4'>
                <div className=' font-secondaryFont'>
                    ...
                    <p className='font-medium text-textColor-50 text-base'>Add all the required information about yourself</p>
                </div>
                <div className=' flex items-center'>
                    <button onClick={()=>handleEditUser()} className='bg-primaryColor text-white font-secondaryFont font-semibold rounded-lg px-8 py-2'>Save Changes</button>
                </div>
            </div>
            ...
            <form
                ...
                <div
                    className="space-x-8 flex border-b-[1px] py-6">
                    <label
                        className="mr-16 font-semibold"
                        htmlFor="picture">
                        Your picture
