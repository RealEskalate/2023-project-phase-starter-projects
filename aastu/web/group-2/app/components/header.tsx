...
const Header: FC = () => {
  ...
  return (
    <div className="shadow-sm sticky z-20 top-0 bg-white flex justify-between text-center w-full h-[90px] py-4 px-9">
      ...
      {openMenu && (
        <nav
          className={`absolute right-0 px-4 py-2 list-none mt-12 bg-slate-100 text-left lg:hidden`}
        >
          <li
            className={`mr-9 font-secondaryFont font-light ${
              currentRoute === '/'
          ...
          <li
            className={`mr-9 font-secondaryFont font-light ${
              currentRoute === '/teams'
                ? 'text-[#264FAD] font-medium mb-2 border-b-[4px] border-[#264FAD] rounded-sm'
                : ' text-[#565656]'
            } pt-2`}
          >
            <Link href="/teams">Teams</Link>
      ...
      <div className="hidden lg:block py-4">
        ...
        <Link
          className="bg-[#264FAD] text-white font-secondaryFont font-bold rounded-lg px-6 py-3"
          href="/donate"
        >
          Donate
        </Link>
