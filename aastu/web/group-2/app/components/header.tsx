...
const Header: FC = () => {
  ...
  return (
    <div className="shadow-sm sticky top-0 bg-white flex justify-between w-full h-[90px] py-4 px-9">
            ...
            {openMenu && (
            <nav className={`absolute right-0 px-4 py-2 list-none mt-12 bg-slate-100 lg:hidden`}>
            ...
            <div className="hidden lg:block py-1">
                <button className="pr-8 font-secondaryFont font-bold"> Login</button>
