...
const ImpactStoriesSection = () => {
  return (
    <section className=' mt-8 flex flex-col justify-center items-center gap-y-12 my-10 md:mt-24'>
      <h2 className='text-textColor-300 font-secondaryFont text-3xl font-bold dark:text-dark-textColor-100'>Impact Stories</h2>

      <div className='grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 lg:gap-x-32 gap-y-5 lg:gap-2 w-11/12 md:w-10/12'>
        <div>
          <h3 className='font-semibold text-lg text-textColor-300 mb-1 md:mb-1.5 dark:text-dark-textColor-100'>Abel Tsegaye</h3>
          <p className='text-base font-medium text-textColor-200 mb-3 md:mb-5 dark:text-dark-textColor-50'>Software Engineer at Google</p>
          <p className='text-textColor-100 = font-normal md:text-left mb-6 md:mb-8 dark:text-dark-textColor-50'>
