  ...
  return (
    <form onSubmit={handleSaveChanges}>
      <div className=" md:px-20 px-2 w-full font-primaryFont py-8 bg-white">
        ...
        <div className="grid-cols-12 sm:ml-2 grid w-[94%] md:mb-48">
          <div className="flex col-span-8 items-center justify-end space-x-3 md:space-x-8 mt-4">
            <button
              className="text-primaryColor py-3 px-4 sm:ml-2 rounded-md text-center text-sm border border-white hover:shadow hover:border-primaryColor"
              onClick={handleCancel}
            >
              Cancel
            </button>
            <button
              className="my-button text-left px-4 py-3 bg-primaryColor text-white rounded-md md:text-center shadow text-sm hover:opacity-95"
              type="submit"
            >
              Save Changes
            </button>
