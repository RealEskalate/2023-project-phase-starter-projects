  ...
  return (
    <div className="flex flex-col rounded-t-md shadow-md font-nav">
      ...
      <div className="flex flex-col p-6 gap-4">
        <h2 className="text-[1.2rem] font-medium ">{data.title}</h2>
        ...
        <div className="flex justify-between">
          <span className="flex items-center justify-center gap-2 font-bold text-gray-500">
            <LuMessageSquare/>
            <p>{`${data.likes} Likes`}</p>
          </span>
          <Link
            className="text-blue-600 font-bold font-nav"
            href={"/blogs/" + data._id}
          >
            {" "}
            Read More
