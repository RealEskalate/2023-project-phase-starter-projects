      ...
      <div className="p-10 flex flex-col sm:flex-row w-full mx-auto">
        ...
        <h1 className="font-bold text-5xl">
          ...
          <div className="mt-10 relative">
            <Image src="/images/about/Rectangle 290.png" alt="" width={80} height={80}/>
            <Image
          ...
          <div className="mt-20">
            <p className="text-gray-600">
              Africa’s future depends on innovation. Transformative technologies  can drive rapid economic growth and lift millions of people out of
              can drive rapid economic growth and lift millions of people out of poverty. However, university computer science education ismisaligned with global market needs and fails to
              incorporate practice-based learning, leaving students unable to apply their
        ...
        <div className="p-4 sm:ml-10 mt-4 sm:mt-0 sm:w-auto">
          <Image className="mt-36 mx-auto" src="/images/about/Problem-solving.png" alt="" width={1000} height={563} />
        </div>
      </div>
      <div className="p-10 flex flex-col sm:flex-row w-full mx-auto">
        <div className="p-20 lg:w-1/2 sm:w-1/2">
          <Image src="/images/about/puzzle.png" alt="" width={600} height={560}/>
        </div>
        <div className="mx-auto mt-10 sm:mt-0">
          ...
          <div className="relative mt-10">
            <Image src="/images/about/Rectangle 290.png" alt="" width={80} height={80} />
            <Image className="absolute bottom-4 left-4" src="/images/about/bulb.png" alt="" width={45} height={50} />
          </div>
          <p className="mt-20">
